...
class reg(tk.Frame): #This is the registration frame
    def __init__(self,parent,controller):
        ...
        def availa(blo,ty,si):#func to show the available rooms
            ...
            #self.TCombobox2.destroy()
            #self.TCombobox3.destroy()
            blo=blo.upper()
            ty=ty.upper()
            if ty=='AC':
                ty='A'
        ...
        self.TCombobox1.place(relx=0.267, rely=0.222, relheight=0.047
                , relwidth=0.238)
        self.TCombobox1.configure(textvariable=blok)
        self.TCombobox1.configure(takefocus="")

        self.TCombobox2 = ttk.Combobox(self)
        self.TCombobox2.place(relx=0.267, rely=0.356, relheight=0.047
                , relwidth=0.238)
        self.TCombobox2.configure(textvariable=t1)
        self.TCombobox2['values'] = ("A","N")
        self.TCombobox2.configure(takefocus="")

        self.TCombobox3 = ttk.Combobox(self)
        self.TCombobox3.place(relx=0.267, rely=0.489, relheight=0.047
                , relwidth=0.238)
        self.TCombobox3.configure(textvariable=capacity)
        self.TCombobox3['values'] = ("1","2","3","4","5","6")
        self.TCombobox3.configure(takefocus="")
        cur.execute("SELECT block from room")
        combovalues=['']
        comboroom = cur.fetchall()
        j=0
        for i in comboroom:
            if j==0:
                combovalues[0]=(i['block'])
            else:
                combovalues.append(i['block'])
            j+=1 
        combovalues=list(dict.fromkeys(combovalues))
        self.TCombobox1['values']= combovalues


        self.Label1 = tk.Label(self)
        self.Label1.place(relx=0.083, rely=0.222, height=21, width=64)
        self.Label1.configure(background="#a1dbcd")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(foreground="#383239")
        self.Label1.configure(text='''BLOCK''')
        self.Label1.configure(width=64)

        self.Label2 = tk.Label(self)
        self.Label2.place(relx=0.083, rely=0.356, height=21, width=64)
        self.Label2.configure(background="#a1dbcd")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(foreground="#383239")
        self.Label2.configure(text='''TYPE''')
        self.Label2.configure(width=64)

        self.Label3 = tk.Label(self)
        self.Label3.place(relx=0.083, rely=0.489, height=21, width=64)
        self.Label3.configure(background="#a1dbcd")
        self.Label3.configure(disabledforeground="#a3a3a3")
        self.Label3.configure(foreground="#383239")
        self.Label3.configure(text='''BEDS''')
        self.Label3.configure(width=64)

        self.Label1.grid(row=4,sticky='N',padx=10,pady=10)
        self.Label2.grid(row=8,sticky='N',padx=10,pady=10)
        self.Label3.grid(row=12,sticky='N',padx=10,pady=10)
        self.TCombobox1.grid(row=6,sticky='N',padx=10,pady=10)
        self.TCombobox2.grid(row=10,sticky='N',padx=10,pady=10)
        self.TCombobox3.grid(row=14)
